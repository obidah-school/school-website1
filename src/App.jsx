...
const cnt = (di, type) => teachers.filter((*, ti) => attendance[ti]?.[di]?.type === type).length;
const totalAbs = (di) => teachers.filter((*, ti) => attendance[ti]?.[di]?.type && attendance[ti][di].type !== “حاضر”).length;
